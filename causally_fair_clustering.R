...
tvd_fair_se <- fairness_cookbook(data = data_fair_se, X = X, W = W, Z = Z, Y = "cluster_fair", 
                              x0 = "female", x1 = "male")
# visualize the x-specific measures of direct, indirect, and spurious effect
autoplot(tvd_fair, decompose = "xspec", dataset = "Census 2018 (Fair Clusters with SE)")
...
tvd_fair4 <- fairness_cookbook(data = data_fair[,c(1:17,19)], X = X, W = W, Z = Z, Y = "cluster_balanced", 
                               x0 = "female", x1 = "male")
# visualize the x-specific measures of direct, indirect, and spurious effect
